...
if (isset($_POST['simpan'])) {
    ...
    if (!in_array($imageFileType, $allowed_extensions)) {
        ...
        if (move_uploaded_file($_FILES['file']['tmp_name'], $target_file)) {
            ...
            $query = "INSERT INTO pengurus_komisariat (nama, email, password, jenis_kelamin, no_tlp, alamat, foto_profil) 
            ...
            if (mysqli_query($conn, $query)) {
                ...
                echo "<meta http-equiv='refresh' content='1;url=kelola_pengurus_komisariat.php'>";
            } else {
...
<body>
    ...
    <div class="container">
        <h4 class="tulisan_input2">TAMBAH PENGURUS KOMISARIAT HMI</h4>
