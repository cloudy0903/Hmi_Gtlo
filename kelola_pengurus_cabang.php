...
if (isset($_GET['hapus']) && isset($_GET['id'])) {
    ...
    $query = "DELETE FROM pengurus_cabang WHERE id = ?";
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>
                Swal.fire({
                    ...
                    window.location.href = 'kelola_pengurus_cabang.php';  // Redirect kembali ke daftar
                });
              </script>";
    } else {
...
<body>
    ...
    <div class="project_area">
        <p class="tulisan_input2">DAFTAR PENGURUS CABANG HMI</p>

        <div class="d-flex justify-content-between mb-3">
            <div>
                <a class="btn btn-dark" href="cetak_pengurus_cabang.php" target="_blank"><i class="fa fa-print"></i> Cetak</a>
                <a class="btn btn-dark" href="tambah_pengurus_cabang.php"><i class="fa fa-user-plus"></i> Tambah</a>
            </div>
...
$query = $cari ? mysqli_query($conn, "SELECT * FROM pengurus_cabang WHERE nama LIKE '%$cari%' OR email LIKE '%$cari%'")
    : mysqli_query($conn, "SELECT * FROM pengurus_cabang LIMIT $posisi, $batas");
$no = 1 + $posisi;
?>
            ...
            if (mysqli_num_rows($query) > 0) {
                while ($row = mysqli_fetch_assoc($query)) {
                    ...
                    echo "<tr>
                        ...
                        <td>
                            <a class='btn btn-edit' href='edit_pengurus_cabang.php?id={$row['id']}'><i class='fas fa-pencil-alt'></i> Edit</a>
...
<?php
$totalData = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM pengurus_cabang"));
    ...
    function hapusPengguna(event, id) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = 'kelola_pengurus_cabang.php?hapus=true&id=' + id; // Arahkan ke halaman penghapusan
            }
        });
    }
</script>
